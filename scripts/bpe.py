...
source_train_value = '--input='+train_source_file_tok+' --model_prefix=source --vocab_size=80000 --hard_vocab_limit=false --model_type=bpe --split_digits=true'
...
target_train_value = '--input='+train_target_file_tok+' --model_prefix=target --vocab_size=80000 --hard_vocab_limit=false --model_type=bpe --split_digits=true'
